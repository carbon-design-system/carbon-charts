...
const ArrowLeftMarker = ({ ...rest }) => <Marker {...Component.arrowLeft} {...rest} />
const ArrowRightMarker = ({ ...rest }) => <Marker {...Component.arrowRight} {...rest} />
const CircleMarker = ({ ...rest }) => <Marker {...Component.circle} {...rest} />
const DiamondMarker = ({ ...rest }) => <Marker {...Component.diamond} {...rest} />
const SquareMarker = ({ ...rest }) => <Marker {...Component.square} {...rest} />
const TeeMarker = ({ ...rest }) => <Marker {...Component.tee} {...rest} />
