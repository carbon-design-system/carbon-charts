...
const ArrowLeftMarker = ({ ...rest }) => <Marker {...components.arrowLeft} {...rest} />
const ArrowRightMarker = ({ ...rest }) => <Marker {...components.arrowRight} {...rest} />
const CircleMarker = ({ ...rest }) => <Marker {...components.circle} {...rest} />
const DiamondMarker = ({ ...rest }) => <Marker {...components.diamond} {...rest} />
const SquareMarker = ({ ...rest }) => <Marker {...components.square} {...rest} />
const TeeMarker = ({ ...rest }) => <Marker {...components.tee} {...rest} />
