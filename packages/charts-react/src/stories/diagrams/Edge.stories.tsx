...
stories.add('Elbow', () => (
	<svg height="800" width="800">
		<g transform="translate(16,16)">
			<Edge path={components.buildElbowPathString(linkSource, linkTargetCurve)} />
		</g>
	</svg>
))
...
stories.add('Bezier', () => (
	<svg height="800" width="800">
		<g transform="translate(16,16)">
			<Edge path={components.buildBezierPathString(linkSource, linkTargetCurve, 150, 280, 150, 30)} />
		</g>
	</svg>
))
