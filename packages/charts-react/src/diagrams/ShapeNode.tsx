...
const ShapeNode: React.FC<ShapeNodeProps & React.HTMLAttributes<HTMLAnchorElement | HTMLDivElement | HTMLButtonElement>> = ({
  shape = 'circle', tag = 'div', title = 'Title', subtitle, description, renderIcon, href,
  size = 48, stacked, position = 'fixed', bodyPosition = 'absolute',
  ...rest
}) => {
