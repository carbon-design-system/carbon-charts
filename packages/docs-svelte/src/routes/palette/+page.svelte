...
<p>
	...
	details, see the <a
		href="https://carbondesignsystem.com/data-visualization/color-palettes/"
		target="_blank">Color Palettes</a>
	section of the <a href="https://carbondesignsystem.com" target="_blank">Carbon Design System</a>.
</p>
...
<p>
	...
	<a href="{base}/options">options</a>. By default, Carbon Charts assigns colors based on the number
	of data groups (eg. charts with four data groups will get the first of the 4-color palettes).
</p>

<CodeSnippet
	type="multi"
	code={`const verySimpleBarData = [
...
<CodeSnippet
	type="multi"
	code={`// Line chart with 2 data groups "Saturday" and "Sunday" initially but expecting
...
<p>
	A custom color range can be provided to be used within the color scale. To do this, define values
	for all data groups in your chart. If fewer data groups are provided than the chart contains, the
	chart will default to using the IBM Design Language data visualization color palette.
</p>

<CodeSnippet
	type="multi"
	code={`const simpleBarOptions = {
  color: {
    scale: {
      "Dataset 1": "blue",
      "Dataset 2": "red"
