...
<Grid noGutter>
	<Row>
		<Column>
			<img
				class="diagram"
				src="{base}/images/chart-anatomy-rectangular.png"
...
<p>
	The title of a piece of visualization should be descriptive and qualitative. It should also
	reflect the main insight the data reveals. The legend should explain the chart’s meaning by
	defining the association of each visual property, such as color, shape, and size, to the
	corresponding data. When possible, use labels directly on the chart to avoid long legends. All the
	text should be concise and easy to understand. Read more on <a href="{base}/legends"
		>legend usage</a
	>.
</p>
...
<p>
	...
	information or context for specific chart elements. A tooltip should repeat the corresponding
	values of the data point on both axes and any other relevant details.
</p>
...
<p>
	...
	and the grid should help the reader understand the proportions and scale of the data, the
	indicators involved, and their unit of measure. Avoid filling the chart frame with too many
	elements, as it impacts the user’s ability to interpret the data. Read more on
...
<Grid noGutter>
	<Row>
		<Column>
			<img
				class="diagram"
				src="{base}/images/chart-anatomy-circular.png"
				alt="Anatomy of a circular chart" />
		</Column>
		<Column>
			<OrderedList native>
				<ListItem>Chart title</ListItem>
