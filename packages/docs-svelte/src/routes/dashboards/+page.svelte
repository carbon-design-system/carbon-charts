...
<p>
	Most people in the west read left to right, then top to bottom. This is known as the <a
		...
		target="_blank">F-shaped pattern</a
	>. Place the most important at the top of the page and follow the F-pattern for the remaining
...
<p>
	...
	breathing room. According to <a
		href="http://www.humanfactors.com/newsletters/yeah_but_can_you_give_me_a_reference.asp"
