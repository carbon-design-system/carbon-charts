...
* **core, angular, react, vue:** allow customizations to pie labels and donut center number ([20793e8](https://github.ibm.com/WatsonSupplyChain/sterling-charts/commit/20793e8))
...
* **angular:** Fix angular SSR issues ([86aa9d3](https://github.ibm.com/WatsonSupplyChain/sterling-charts/commit/86aa9d3))
* custom global object in UMD bundle generated by webpack ([a4d1e54](https://github.ibm.com/WatsonSupplyChain/sterling-charts/commit/a4d1e54))
* **core:** update type to scaleType and backgroundColors to fillColors ([3ca0a0f](https://github.ibm.com/WatsonSupplyChain/sterling-charts/commit/3ca0a0f))
* **core:** update typescript version ([949379f](https://github.ibm.com/WatsonSupplyChain/sterling-charts/commit/949379f))
* **core, react:** fix react SSR & legend sizing issues ([abedba0](https://github.ibm.com/WatsonSupplyChain/sterling-charts/commit/abedba0))
...
* **tooltip:** fix to be multiline instead of multitooltip ([0f90325](https://github.ibm.com/WatsonSupplyChain/sterling-charts/commit/0f90325))


### Features

* **core:** support width & maxWidth values for bars ([a2e7120](https://github.ibm.com/WatsonSupplyChain/sterling-charts/commit/a2e7120))
