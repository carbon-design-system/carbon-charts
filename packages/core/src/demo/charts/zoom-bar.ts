...
export const zoomBarStackedAreaTimeSeriesData = areaChart.stackedAreaTimeSeriesData
...
export const zoomBarStackedBarTimeSeriesData = barChart.stackedBarTimeSeriesData
export const zoomBarStackedBarTimeSeriesOptions = addZoomBarToOptions(
	Object.assign({}, barChart.stackedBarTimeSeriesOptions)
)

export const definedZoomBarStackedBarTimeSeriesData = barChart.stackedBarTimeSeriesData
...
export const zoomBarLineTimeSeries15secondsData = timeSeriesAxisChart.lineTimeSeriesData15seconds
...
export const zoomBarLineTimeSeriesInitDomainData = timeSeriesAxisChart.lineTimeSeriesData15seconds
