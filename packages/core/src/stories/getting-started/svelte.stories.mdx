...
**Using yarn**
```bash
yarn add @carbon/charts-svelte d3 d3-cloud d3-sankey
```

**Using npm**
```bash
npm install --save @carbon/charts-svelte d3 d3-cloud d3-sankey
```
...
## Demos and Examples
+ **[Storybook - Story Sources](https://github.com/carbon-design-system/carbon-charts/tree/master/packages/svelte/src/stories)**
...
#### Using the server
We recommend the use of [Svelte Storybook](https://storybook.js.org/docs/svelte/get-started/why-storybook)
...
To see our **Svelte** getting started guide, go to our [Svelte storybook site](https://charts.carbondesignsystem.com/svelte/?path=/docs/docs-getting-started-svelte--docs)
