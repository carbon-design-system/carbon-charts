...
storybookDemoGroups.forEach((demoGroup) => {
	...
	demoGroup.demos.forEach((demo) => {
		...
		groupStories.add(demo.title, () => {
			...
			container.innerHTML = `
${storyUtils.generateStoryHeader(
...
`;
			...
			const defaultStorybookHTML = `<div class="marginTop-30" id="chart-demo"></div>
`;
			// story-based HTML elements
			container.innerHTML = demo.storybookHTML
				? container.innerHTML + demo.storybookHTML
				: container.innerHTML + defaultStorybookHTML;
