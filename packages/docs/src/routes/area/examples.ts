import { type AreaChartOptions, type ChartTabularData, ScaleTypes } from '@carbon/charts-svelte'
import { addZoomBarToOptions } from '$lib/zoombar'
...
const optionsZoomBar: AreaChartOptions = addZoomBarToOptions(Object.assign({}, optionsMultipleBounded))
