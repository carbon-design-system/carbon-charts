...
<p><img class="example" src="{base}/images/axislabel-zero-good2.png" alt="Chart where it makes sense to start with zero"/></p>
...
<p><img class="example" src="{base}/images/axislabel-gap.png" alt="Chart with gap in the data"/></p>
...
<p><img class="example" src="{base}/images/axislabel-break-1.png" alt="Chart with break in the data"/></p>

<p>If data isn’t available between axis breakpoints, leave the area empty.</p>

<p><img class="example" src="{base}/images/axislabel-break-2.png" alt="Chart with break in the data"/></p>
...
<p><img class="example" src="{base}/images/axislabel-timeseries.png" alt="Example of a time series plotted at 15 seconds intervals"/></p>
...
<p><img class="log" src="{base}/images/axis-logarithmic.png" alt="Example of a logarithmic axis"/></p>
